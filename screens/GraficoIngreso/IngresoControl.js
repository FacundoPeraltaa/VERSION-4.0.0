...
function Grafico() {
  ...
  return (
    ...
    <Text style={styles.infoTitle}>Estado de animales </Text>
    <FlatList
        ...
        <View style={styles.infoItem}>
          ...
          {selectedAnimals.listType === 'secosNaN' && (
            <>
              ...
              <Text style={styles.textLabel}>RFID: {item.RFID}</Text>
              <Text style={styles.textLabel}>Estado de Producción: {item.estPro}</Text>
              <Text style={styles.textLabel}>Estado de Reproducción: {item.estRep}</Text>
            </>
          )}
