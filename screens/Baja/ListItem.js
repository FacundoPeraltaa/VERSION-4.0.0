...
export default function ListItem({ data,registrarBaja}) {

  const { rp,estrep,estpro,categoria,diasLact } = data;
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.text}>RP: {rp} ({siglas.cat}/{siglas.prod}/{siglas.rep}) - DIAS LACT: {diasLact} </Text>
      </View>
    </TouchableHighlight>
  )
}
